...
const Navbar = () => {
  ...
  return (
    <header className={cn(
      "fixed top-0 left-0 right-0 z-40 px-4 py-3 transition-transform duration-300 md:px-8 md:py-3.5",
      navVisible ? "translate-y-0" : "-translate-y-full",
      scrolled
        ? "bg-white/92 shadow-lg backdrop-blur dark:bg-gray-900/92"
        : "bg-gradient-to-br from-teal-50/80 to-white/80 backdrop-blur dark:from-gray-900/90 dark:to-gray-950/90"
    )}>
