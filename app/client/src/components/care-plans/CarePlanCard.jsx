...
const CarePlanCard = ({ carePlan, onOpen }) => {
    const Icon = getCarePlanIcon(carePlan.iconKey);

    return (
        <article className="group rounded-[1.9rem] border border-slate-200 bg-white p-6 shadow-[0_18px_45px_-35px_rgba(15,23,42,0.28)] transition hover:-translate-y-1 hover:shadow-[0_26px_60px_-36px_rgba(14,116,144,0.32)] dark:border-slate-800 dark:bg-slate-900">
            ...
            <h3 className="mt-5 text-xl font-semibold text-slate-900 dark:text-white">{carePlan.name}</h3>
            <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">{carePlan.summary}</p>
