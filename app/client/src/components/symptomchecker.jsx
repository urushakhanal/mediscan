    ...
    >
      ...
      >
        ...
        <div className="mt-5 flex gap-3">
          <button onClick={onClose} className="rounded-lg border border-slate-200 px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-400 dark:hover:bg-slate-800">
            Close
          </button>
          <button onClick={() => exportToPDF(analysis)} className="rounded-lg bg-slate-900 px-4 py-2 text-sm text-white hover:bg-slate-700 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200">
            Export PDF
          </button>
        </div>
      </motion.div>
